...
dummy <- 1
params_in_sens <- c("dummy",param_names)

print(paste("the model has",length(params_in_sens)-1,"parameters"))
...
# #set path to driver data
# driver_data_path <- "~/cloud/gdrive/rec_submodel/data/ED2_dryDS/"
# 
# 
# param_sens_data <- tibble()
# 
...
# }
# 
# write_csv(param_sens_data, "temp/param_sens_data_DRY_DS.csv")
