...
F_seed <- 0.5 * 0.48 #the fraction of reproductive carbon that is seed; was .82
...
F_repro_ED2 <- 0.1
seedling_mortality <-  1 - (0.05^(1/30.4) * 0.015)  # mortality rate in every time step. Taken from ED2 code: ./init/ed_params.f90:2089
